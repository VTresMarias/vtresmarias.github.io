...
function aura_hover() {
  document.getElementById("aura-hover").src = "https://vtresmarias.github.io/vtm_aura_hover.svg";
...
function aga_hover() {
  document.getElementById("aga-hover").src = "https://vtresmarias.github.io/vtm_aga_hover.svg";
...
function hina_hover() {
  document.getElementById("hina-hover").src = "https://vtresmarias.github.io/vtm_hina_hover.svg";
